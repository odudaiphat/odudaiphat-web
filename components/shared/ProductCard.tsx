...
export function ProductCard({ product }: { product: Product }) {
  return (
    <Link
      href={product.href}
      className="group flex h-full flex-col overflow-hidden rounded-[28px] border border-[#ece6dd] bg-white shadow-[0_14px_40px_rgba(32,29,24,0.045)] transition duration-300 hover:-translate-y-1 hover:border-[#d9c7ad] hover:shadow-[0_30px_80px_rgba(0,0,0,0.08)]"
    >
      ...
      <div className="flex flex-1 flex-col px-4 pb-4 pt-5 sm:px-5 sm:pb-5 sm:pt-6">
        <h3 className="text-[18px] font-semibold leading-[1.2] tracking-[-0.02em] text-[#1f1f1c] transition group-hover:text-[#9a6b2f] sm:text-[22px] sm:font-black">
          {product.name}
        </h3>
        ...
        <div className="mt-auto pt-5 sm:pt-6">
          <div className="inline-flex min-h-11 w-full items-center justify-center rounded-2xl bg-[#1f1f1c] px-4 py-3 text-xs font-semibold uppercase tracking-[0.08em] text-white transition duration-300 group-hover:bg-[#9a6b2f] sm:px-5 sm:py-3.5 sm:text-sm">
            Xem chi tiết
          </div>
        </div>
      </div>
